    ...
    <header x-data="{ open: false }" class="sticky top-0 z-50 bg-algeciras-black text-white border-b-2 border-algeciras-red">
        <div class="container mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <a href="{{ route('area-personal') }}"
                   ...
                   class="px-3 py-2 border border-white/30 hover:border-algeciras-red hover:text-algeciras-red transition font-display tracking-wider uppercase text-xs"
                   title="Área personal — socios">
                    ...
                    <span style="display: inline;">Área personal</span>
                </a>
        ...
        <div x-show="open" x-cloak x-transition class="lg:hidden border-t border-white/10 bg-algeciras-black">
            <nav class="container mx-auto px-4 py-4 flex flex-col gap-3 font-display tracking-wider text-lg uppercase">
                ...
                @endforeach
                <a href="{{ route('area-personal') }}" class="mt-2 inline-flex items-center justify-center gap-2 px-4 py-3 border border-white/30 text-center">
                ...
                <a href="{{ route('abonos') }}" class="inline-block px-4 py-3 bg-algeciras-red text-center">Hazte abonado</a>
